"use strict";
(self["webpackChunkbelavista_portal"] = self["webpackChunkbelavista_portal"] || []).push([["node_modules_firebase_compat_auth_dist_esm_index_esm_js"],{
...
/* harmony import */ var _app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
function _isCordova2() {
  _isCordova2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    if (!_isLikelyCordova()) {
      return false;
    }
...
function _savePersistenceForRedirect2() {
  _savePersistenceForRedirect2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth) {
...
class CompatPopupRedirectResolver {
  ...
  _initialize(auth) {
    var _this = this;
    return (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
function _convertConfirmationResult() {
  _convertConfirmationResult = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, confirmationResultPromise) {
...
function _generateHandlerUrl2() {
  _generateHandlerUrl2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, event, provider) {
    var _a;
...
function _validateOrigin2() {
  _validateOrigin2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth) {
    const {
      BuildInfo
    } = _cordovaWindow();
    const request = {};
...
function _waitForAppResume2() {
  _waitForAppResume2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth, eventListener, iabRef) {
    // Get the cordova plugins
    const {
      cordova
    } = _cordovaWindow();
...
function _computeSha() {
  _computeSha = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (sessionId) {
...
function _getAndRemoveEvent2() {
  _getAndRemoveEvent2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (auth) {
...
class CordovaPopupRedirectResolver {
  ...
  attachCallbackListeners(auth, manager) {
    ...
    const noEventTimeout = setTimeout( /*#__PURE__*/(0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    const universalLinksCb = /*#__PURE__*/function () {
      var _ref2 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (eventData) {
    ...
    _cordovaWindow().handleOpenURL = /*#__PURE__*/function () {
      var _ref3 = (0,_app_belavista_portal_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url) {
